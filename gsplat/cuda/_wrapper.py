...
def count_imp_wrapper(
    ...
    render_colors, render_alphas, render_imps = _CountImps.apply(
        means2d.contiguous(),
        conics.contiguous(),
        colors.contiguous(),
        opacities.contiguous(),
    ...
    if padded_channels > 0:
        render_colors = render_colors[..., :-padded_channels]
    return render_colors, render_alphas, render_imps
...
class _CountImps(torch.autograd.Function):
    """Counting Imporatance of Gaussians"""
    ...
    def forward(
        ...
        render_colors, render_alphas, last_ids, render_imps = _make_lazy_cuda_func(
            "count_imp_tensor"
        )(
            means2d,
            conics,
